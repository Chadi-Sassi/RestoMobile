...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String USERS_TABLE_NAME = "utilisateurs";
    public static final String USERS_COLUMN_ID = "id";
    public static final String USERS_COLUMN_NAME = "name";
    public static final String USERS_COLUMN_EMAIL = "email";
    public static final String USERS_COLUMN_STREET = "street";
    public static final String USERS_COLUMN_CITY = "place";
    ...
    public boolean insertUtilisateur (String name, String phone, String email, String street,String place) {
    ...
    public Cursor getData(int id) {
        ...
        Cursor res =  db.rawQuery( "select * from utilisateurs where id="+id+"", null );
        return res;
    }
    ...
    public boolean updateUser (Integer id, String name, String phone, String email, String street,String place) {
        ...
        contentValues.put("street", street);
        contentValues.put("place", place);
        db.update("utilisateurs", contentValues, "id = ? ", new String[] { Integer.toString(id) } );
        return true;
    }
